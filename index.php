                ...
                <div id="da-slider" class="da-slider">
                    ...
                    <div class="container">
                        ...
                        for ($i=0;$i<7;$i++)
                        {
                            ?>
                            <div class="da-slide">
                                <h2 class="fittext2">ggg Welcome to pluton theme</h2>
...
<!--                                <a href="#" class="da-link button">Read more</a>-->
        ...
        <div id="blog" class="section secondary-section">
            <div class="container">
                        ...
                        <ul class="timeline">
                            <li  >
                                <div class="timeline-image">
                                    <a href="http://pluton.themeart.co/markup-and-formatting/" title="Markup And Formatting">
                                        <img width="200" height="200" src="http://pluton.themeart.co/wp-content/uploads/2013/03/cabin-200x200.png" class="img-circle wp-post-image" alt="cabin" />									</a>
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <span>January 11, 2013</span>
                                        <h3 class="subheading"><a href="http://pluton.themeart.co/markup-and-formatting/" title="Markup And Formatting">Markup And Formatting</a></h3>
                                    </div>
                            ...
                            <li class="timeline-inverted" >
                                <div class="timeline-image">
                                    <a href="http://pluton.themeart.co/image-alignment/" title="Image Alignment">
                                        <img width="200" height="200" src="http://pluton.themeart.co/wp-content/uploads/2013/01/cake-200x200.png" class="img-circle wp-post-image" alt="cake" />									</a>
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <span>January 10, 2013</span>
                                        <h3 class="subheading"><a href="http://pluton.themeart.co/image-alignment/" title="Image Alignment">Image Alignment</a></h3>
                                    </div>
                                    <div class="timeline-body">
                            ...
                            <li  >
                                <div class="timeline-image">
                                    <a href="http://pluton.themeart.co/text-alignment/" title="Text Alignment">
                                        <img width="200" height="200" src="http://pluton.themeart.co/wp-content/uploads/2013/01/circus-200x200.png" class="img-circle wp-post-image" alt="circus" />									</a>
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <span>January 9, 2013</span>
                                        <h3 class="subheading"><a href="http://pluton.themeart.co/text-alignment/" title="Text Alignment">Text Alignment</a></h3>
                                    </div>
                                    <div class="timeline-body">
                            ...
                            <li class="timeline-inverted" >
                                <div class="timeline-image">
                                    <a href="http://pluton.themeart.co/sticky/" title="Sticky">
                                        <img width="200" height="200" src="http://pluton.themeart.co/wp-content/uploads/2013/01/game-200x200.png" class="img-circle wp-post-image" alt="game" />									</a>
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <span>January 7, 2013</span>
                                        <h3 class="subheading"><a href="http://pluton.themeart.co/sticky/" title="Sticky">Sticky</a></h3>
                                    </div>
                                    <div class="timeline-body">
                ...
                <p class="centered"><a href="http://pluton.themeart.co/blogpage/" class="button">More Posts</a></p>
            </div>
        </div>
